...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7960_axis_wrapper is
  ...
  attribute SOFT_HLUTNM of m_axis_tlast_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \sample_cnt[2]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \sample_cnt[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sample_cnt[7]_i_2\ : label is "soft_lutpair0";
begin
  m_axis_tlast <= \^m_axis_tlast\;
  m_axis_tvalid <= \^m_axis_tvalid\;
frame_active_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF7CCCC00000000"
    )
        port map (
      I0 => adc_valid,
      I1 => m_axis_tready,
