...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7960_axis_wrapper is
  ...
  signal \sample_cnt_reg_n_0_[3]\ : STD_LOGIC;
  signal \sample_cnt_reg_n_0_[4]\ : STD_LOGIC;
  signal tready_d : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sample_cnt[4]_i_2\ : label is "soft_lutpair0";
begin
...
\m_axis_tdata[17]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
tready_d_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => m_axis_tready,
